...
# 3. CREATE FLASK APP
# ------------------------------------------------------------
# NOTE: Using async_mode='threading' instead of 'eventlet'
# because eventlet has known DNS bugs on Windows. Threading
# works reliably both locally and on Render with gthread worker.
# ============================================================
app = Flask(__name__)
...
# 4. SUPABASE SETUP
# ------------------------------------------------------------
# Using plain `requests` calls to Supabase REST API instead of
# the supabase-py client library, which was intermittently
# timing out. This matches the approach in main.py on the Pi.
# ============================================================
...
# ============================================================
# 10. START BACKGROUND TASK (runs even under Gunicorn on Render)
# ------------------------------------------------------------
# This MUST be outside `if __name__ == '__main__'` so that
# Gunicorn (used by Render) also triggers the broadcaster when
# it imports the `app` module.
# ============================================================
socketio.start_background_task(sensor_loop)

# ============================================================
# 11. RUN THE APP (local development only)
# ============================================================
