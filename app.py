# ============================================================
# 1. EVENTLET PATCH - DAPAT ITO ANG PINAKA-UNA!
# ============================================================
import eventlet
eventlet.monkey_patch()

# ============================================================
# 2. LAHAT NG IBA PANG IMPORTS
# ============================================================
...
# 5. SUPABASE SETUP
# ============================================================
SUPABASE_URL = os.getenv('https://iaagaxnijxferkruioxi.supabase.co')
SUPABASE_ANON_KEY = os.getenv('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlhYWdheG5panhmZXJrcnVpb3hpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODgyODcxODcsImV4cCI6MjEwMzg2MzE4N30.P8KZFzOaQ9TjkCjT7c8f4sJmPvoBNydAo44EZL-eLt4')
    ...
    while True:
        try:
            ...
            if USE_SUPABASE:
                ...
                if latest is None:
                    # No data in Supabase yet (e.g. Pi hasn't sent anything)
                    time.sleep(5)
                    continue
